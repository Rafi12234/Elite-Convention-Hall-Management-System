...
import eliteLogo from "../../office/assets/elite-logo.png";
import BackButton from "../../office/components/BackButton";
import EmployeeLayout from "../../office/components/EmployeeLayout";
import { loadCurrentEmployee } from "../../office/services/authStorage";
        ...
        <header className="sticky top-0 z-40 border-b border-black/8 bg-white/80 backdrop-blur-xl">
          <div className="flex min-h-18 items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
            <div className="flex min-w-0 items-center gap-3">
              <img src={eliteLogo} alt="Elite Convention Hall" className="h-14 w-auto shrink-0 object-contain sm:h-16" />
          ...
          <section className="mx-auto max-w-[1700px]">
            <div className="mm-fade mb-5 flex flex-wrap items-end justify-between gap-4">
              <div className="flex items-center gap-3">
                <BackButton to="/office/management" title="Back to management" />
                <div>
