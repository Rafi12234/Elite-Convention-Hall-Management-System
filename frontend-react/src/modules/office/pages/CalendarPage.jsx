    ...
    >
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex shrink-0 items-center gap-1.5">
          <button
            type="button"
            onClick={() => navigate(`/office/management/meetings/${rowKey}`, { state: { from: "/office/calendar" } })}
          ...
          <button
            type="button"
            onClick={() => navigate(`/office/management/calls/${rowKey}`, { state: { from: "/office/calendar" } })}
      ...
      <header className="sticky top-0 z-40 border-b border-[#d6d6d6]/50 bg-white/95 backdrop-blur-xl">
        <div className="flex min-h-18 items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
          <div className="flex min-w-0 items-center gap-3">
            <img src={eliteLogo} alt="Elite Convention Hall" className="h-16 w-auto shrink-0 object-contain sm:h-18" />
              ...
              <div className="grid grid-cols-7">
                {calendarDays.map((info, idx) => {
                  ...
                  return (
                    <button
                      key={info.date}
                      onClick={() => navigate(`/office/calendar/day/${info.date}`)}
                      className={[
