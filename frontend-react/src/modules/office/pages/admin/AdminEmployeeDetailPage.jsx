...
export default function AdminEmployeeDetailPage() {
  ...
  return (
    <AdminLayout admin={admin} onLogout={handleLogout}>
      ...
      <div className="mb-5">
        <BackButton to="/office/admin-employee-management" title="Back to Employee Management" />
      </div>
      ...
      {isLoading ? (
        ...
        <>
          ...
          {missedCount > 0 ? (
            <button
              onClick={() => navigate(`/office/admin-employee-management/${employee.id}/missed`)}
                      ...
                      <ul className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                        {filteredPrevious.map((entry, i) => (
                          <RoutineEntryRow
                            ...
                            entry={entry}
                            index={i}
                            backTo={`/office/admin-employee-management/${employee.id}`}
