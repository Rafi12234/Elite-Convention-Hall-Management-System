...
function EmployeeActivityRow({ bucket }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 rounded-2xl border border-mme-pink/50 bg-white px-4 py-3.5 transition hover:border-mme-pink hover:shadow-sm">
      ...
      <button
        onClick={() => navigate(`/office/admin-employee-management/${employee.id}`)}
...
export default function AdminPage() {
  ...
  return (
    <AdminLayout admin={admin} onLogout={handleLogout}>
        <div className="mb-5">
          <BackButton to="/office" title="Back to app" />
        </div>
        ...
        <button
          onClick={() => navigate("/office/admin-employee-management/accounts")}
