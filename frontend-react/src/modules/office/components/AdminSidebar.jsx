...
const NAV_ITEMS = [
  { to: "/office/admin-dashboard", label: "Dashboard", icon: Gauge },
  { to: "/office/admin-employee-management", label: "Employee Management", icon: UsersRound },
  { to: "/office/admin/clients-management", label: "Client Informations & Management", icon: LayoutGrid },
  { to: "/office/admin/activity", label: "Meeting & Call Oversight", icon: Phone },
  { to: "/office/admin/attendance", label: "Attendance Management", icon: Clock },
  { to: "/office/admin/calendar", label: "Company Calendar", icon: CalendarDays },
  // Financial Accounts — separate from Employee Management, which handles
  // login accounts/passwords rather than money.
  { to: "/office/admin/accounts", label: "Financial Accounts", icon: Wallet },
];
        ...
        <div className="flex items-center justify-between gap-3 border-b border-mme-pink/50 px-5 py-4">
          <div className="flex min-w-0 items-center gap-3">
            ...
            >
              ...
              <p className="truncate text-[10px] font-bold uppercase tracking-[0.18em] text-mme-plum">Elite Convention Hall</p>
            </div>
          </div>
          <button
            onClick={onClose}
