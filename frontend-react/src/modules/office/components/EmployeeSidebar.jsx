...
const NAV_ITEMS = [
  { to: "/office/management", label: "Management", icon: LayoutGrid },
  { to: "/office/accounts", label: "Accounts", icon: Wallet },
];
        ...
        <div className="flex items-center justify-between gap-3 border-b border-black/10 px-5 py-4">
          <div className="flex min-w-0 items-center gap-3">
            ...
            >
              ...
              <p className="truncate text-[10px] font-bold uppercase tracking-[0.18em] text-black/40">Elite Convention Hall</p>
            </div>
          </div>
          <button
            onClick={onClose}
